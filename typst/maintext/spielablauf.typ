...
#boxes.fluffbox(
	[
		...
		Es kann vorkommen, dass ein Team durch einen Frühstart~(@fruehstart) den Spielzug mit Juggvorteil startet. In diesen Fällen liegt der Jugg zu Zugbeginn nicht auf dem Mittelpunkt des Spielfeldes.
...
- ein*e Spieler*in des Teams das Spielfeld betritt, ohne die zugehörge Anlaufzone während des gesamten Intervalls zwischen dem letzten Stein des Countdowns und dem Startsignal berührt zu haben.
