...
#boxes.fluffbox([
  Die Schlagfläche ist der rund gepolsterte Bereich einer Nahpompfe, welcher für das gültige Treffen (@treffer_platz) und Pinnen (@pinnen) genutzt werden kann. Jede Schlagfläche hat eine Stechspitze (@stechspitze). Die Stechspitze ist Teil der Schlagfläche.
