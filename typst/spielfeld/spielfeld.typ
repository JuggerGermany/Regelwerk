...
Die Gesamtlänge beträgt #strong[40_m] (#strong[30_m]).
Die Gesamtbreite beträgt #strong[20_m] (#strong[15_m]).
Der Bereich außerhalb des Spielfeldes ist das #emph[Aus].
Das Spielfeld wird mit Linien abgegrenzt.
Die kurzen, sich gegenüberliegenden #strong[10_m] (#strong[7,5_m]) langen Linien sind die #emph[Grundlinien].
