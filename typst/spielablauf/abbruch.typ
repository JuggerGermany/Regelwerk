#let title = "Abbruch eines Spielzugs"

Ein Spielzug kann abgebrochen werden, sobald die Sicherheit oder das
Fairplay der Spieler*innen nicht mehr gewährleistet ist, z.B. durch:
- eine Verletzung.
