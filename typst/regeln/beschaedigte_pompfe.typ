...
Er*sie verstößt damit nicht gegen das Aus. Der*die Pompfer*in muss so schnell wie möglich das Spielfeld an derselben Stelle wieder betreten, an der er*sie
dieses verlassen hat.

Während der*die Pompfer*in die eigene Pompfe vom Spielfeld entfernt und sich eine neue holt, ist es ihm*ihr verboten, mit dem Jugg zu interagieren, andere Feldspieler*innen zu treffen, zu pinnen.
